...
Tracker.prototype.enable_server = function (settings) {
  ...
  server.listen(settings.port, function () {
    ...
    console.log('listening on http port:' + self.server.http.address().port)
    console.log('listening on udp port:' + self.server.udp.address().port)
    console.log('listening on ws port:' + self.server.ws.address().port)
  })
